...
<div class="main-content">
        <section class="section">
          <div class="section-header">
            ...
            <h1>Surat Keterangan Berkelakuan Baik</h1>
                ...
                <form id="setting-form">
                  <div class="card" id="settings-card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group row align-items-center">
                        <label for="site-title" class="form-control-label col-sm-3 text-md-right">Pekerjaan</label>
                        <div class="col-sm-6 col-md-9">
                          <input type="text" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="form-group row align-items-center">
                        <label for="site-title" class="form-control-label col-sm-3 text-md-right">Keperluan</label>
                        <div class="col-sm-6 col-md-9">
                          <input type="text" class="form-control">
                        </div>
                      </div>
